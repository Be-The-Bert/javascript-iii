...
class ProgressiveManager {
    ...
    checkTitle() {
        ...
        employees === 0 ? this.title = 'Not a manager':
            employees > 0 && employees < 4 ? this.title = 'Barely Manager':
                employees >= 4 && employees < 11 ? this.title = 'Mostly Manager':
                    employees >= 11 && employees < 51 ? this.title = 'Manager':
                        employees >= 51 && employees < 101 ? this.title = 'Manager Plus': this.title = 'Bestest Manager'
    }
}
